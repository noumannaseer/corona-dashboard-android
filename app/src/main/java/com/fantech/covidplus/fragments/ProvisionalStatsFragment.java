...
import com.fantech.covidplus.adapters.ProvinceListAdapter;
import com.fantech.covidplus.databinding.FragmentProvisionalStatsBinding;
    ...
    //*******************************************************
    {
        ...
        mCoronaStatsViewModel.getProvinceList(mCountryName)
                             .observe(this,
                                      ...
                                      {
                                          @Override
                                          public void onChanged(List<String> coronas)
                                          {
                                              showProvinceOnRecyclerView(coronas);
